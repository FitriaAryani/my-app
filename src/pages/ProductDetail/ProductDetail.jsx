        ...
        <div className='flex flex-col gap-[20px]'>
          ...
          {product.stock > 0 ? (
            <div>
              <Button
                type='button'
                className='rounded-lg inline-flex items-center justify-center gap-2 p-4 bg-[#543310] text-center hover:bg-[#B3A398] text-white active:bg-[#4956ab]'
              >
            ...
            <div>
              <Button
                type='button'
                className='rounded-lg inline-flex items-center justify-center gap-2 p-4 bg-[#9A9A9A] text-center'
              >
                <FontAwesomeIcon icon={faCartShopping} className='mb-0 text-white' />
